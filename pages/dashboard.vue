                       ...
                       <div class="card-body">
                           <div class="d-flex">
                               <div class="flex-grow-1">
                                   ...
                                   <h4 class="mb-2">{{ UsersCount.data }}</h4>
               ...
               <div class="col-xl-3 col-md-6">
                   <div class="card">
                       <div class="card-body">
                           <div class="d-flex">
                               <div class="flex-grow-1">
                                   <p class="text-truncate font-size-14 mb-2">  Product</p>
                                   <h4 class="mb-2">{{ProductCount.data}}</h4>
               ...
               <div class="col-xl-3 col-md-6">
                   <div class="card">
                       <div class="card-body">
                           <div class="d-flex">
                               <div class="flex-grow-1">
                                   <p class="text-truncate font-size-14 mb-2">Role</p>
                                   <h4 class="mb-2">{{RoleCount.data}}</h4>
               ...
               <div class="col-xl-3 col-md-6">
                   <div class="card">
                       <div class="card-body">
                           <div class="d-flex">
                               <div class="flex-grow-1">
                                   <p class="text-truncate font-size-14 mb-2">Permission</p>
                                   <h4 class="mb-2">{{PermissionCount.data}}</h4>
...
getUserCount(){
        ...
        // this.isLoading=true;
        axios.get(`http://127.0.0.1:8000/api/total/user/count`)
            .then(res=>{
...
axios.get(`http://127.0.0.1:8000/api/total/role/count`)
    .then(res=>{
      ...
      this.RoleCount = res.data;
       console.log("All Role",this.RoleCount);
...
axios.get(`http://127.0.0.1:8000/api/total/permission/count`)
.then(res=>{


this.PermissionCount = res.data;
console.log("All Permission",this.PermissionCount);
...
console.log("All Product",this.ProductCount);
